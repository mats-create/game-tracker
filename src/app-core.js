...
function TacticsBoard(){
  ...
  function symbolHitR(size){return(SSIZES[size]||SSIZES.m)+4;}
  ...
  function drawPitch(ctx,v){
    ...
    const pc1=pm==='aida'?'#e8f0e8':pm==='gray'?'#555555':'#3a7d44';
    const pc2=pm==='aida'?'#dceadc':pm==='gray'?'#444444':'#2f6b38';
    const L=pm==='aida'?'#4A6741':pm==='gray'?'rgba(255,255,255,0.55)':'rgba(255,255,255,0.88)';
