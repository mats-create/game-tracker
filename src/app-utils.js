...
// React preserves useState across re-renders only for module-scope components.
...
function PlayerPanel({S,activeTeam,setActiveTeam,expandedId,toggleExpanded,addGhost,removeGhost,togglePlayerHidden,updatePlayerNum,getGhosts,redraw}){
